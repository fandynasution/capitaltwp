                                ...
                                <form action="{{ url('/login') }}" method="POST" id="formlogin" class="needs-validation" novalidate="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="bsn" name="bsn" class="form-control form-control-lg" required="true">
                                            ...
                                            <!-- <option value="1">PT. Api Metra Graha</option> -->
                                        </select>
                                    </div><!-- .foem-group -->
                                    <div class="form-group">
                                        <div class="form-label-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <div class="input-group">
                                                <input type="password"
                                                        class="form-control @error('password') is-invalid @enderror" name="password" id="password" placeholder="Enter your password" required = "true">
                                                <div class="input-group-append">
                                                    <span class="input-group-text btn-show-pass"><em class="icon ni ni-eye-fill"></em></span>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script type="text/javascript">
        ...
        $('.btn-show-pass').on('click', function(){
            if(showPass == 0) {
                ...
                $(this).find('em').removeClass('ni-eye-fill');
                $(this).find('em').addClass('ni-eye-off-fill');
                showPass = 1;
            }
            else {
                // $(this).next('input').attr('type','password');
                $("#password").prop("type", "password");
                $(this).find('em').addClass('ni-eye-fill');
                $(this).find('em').removeClass('ni-eye-off-fill');
                showPass = 0;
            }
        });
    </script>
