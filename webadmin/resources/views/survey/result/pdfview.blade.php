...
<html>
  <head>
    ...
    <link href="{{ url('assets/css/exportpdf/bootstrap.min.css');}}" rel="stylesheet" type="text/css" />
    <link href="{{ url('assets/css/exportpdf/skin-yellow.min.css'); }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('assets/css/exportpdf/AdminLTE.min.css'); }}" rel="stylesheet" type="text/css" />
        ...
        <?php 
            ...
            foreach ($dtsurvey as $key) {
                ...
                if($s!= $q){
                    ...
                    // echo $key->line_no.'. '.$key->options;
                    // echo '<div class="row">';
                    // echo '<div width="75%">'. ' 
                    //                 <div class="progress progress-lg" width= style="margin-bottom: 20px;">
                    //                     <div class="progress-bar progress-bar-striped" role="progressbar" aria-valuenow="'.(int)$JDebtor.'" aria-valuemin="'.(int)$JDebtor.'" aria-valuemax="100"
                    //                     style="width:'.(int)$JDebtor.'%"></div>
                    //                 </div>
                    //             </div>
                    //         <div width="25%">
                    //             <span class="badge badge-pill" style="margin-left:15px;color: #fff;background-color: #17a2b8;">'.(int)$JDebtor.'%</span>
                    //         </div>';
                    // echo '</div>';
                }
