...
class NewsPromoController extends Controller
{
    ...
    {
        // $entity_cd     = Session::get('Tsentity_cd');
        // $project_no     = Session::get('Tsproject_no');
    ...
    public function save(Request $request)
    {
        ...
        $start_date_mmddyy = $start_date[1]."/".$start_date[0]."/".$start_date[2];
        $end_date = explode('/',$request->end_date);
        $end_date_mmddyy = $end_date[1]."/".$end_date[0]."/".$end_date[2]." 23:59:59";
        // var_dump($start_date[0]);
        // var_dump($end_date_mmddyy);
        // var_dump(date('d M Y H:i:s',strtotime($end_date_mmddyy)));
        ...
        $data = array(
            ...
            // 'start_date'    => date('d M Y H:i:s',strtotime($start_date_mmddyy)),
            // 'end_date'       => date('d M Y H:i:s',strtotime($end_date_mmddyy)),
