...
<div class="nk-header nk-header-fixed is-light">
    <div class="container-fluid">
        <div class="nk-header-wrap">
            ...
            @php
                // $project_name = Session::get('Tsproject_descs');
                // $project_pict = Session::get('Tsproject_picture');
                // if ($project_pict == NULL) {
                //     $ppict = 'images/PlProject/white.png';
                // } else {
                //     $ppict = $project_pict;
                // }
                $data = '';
            ...
            <div class="nk-header-tools">
                <ul class="nk-quick-nav">
                    {{-- <img src="{{ $ppict }}" width="40" height="40" style="border-radius: 20%;" class="mr-2">
                    <a href="{{ url('/dash') }}" style="font-weight: bold;"></a> --}}
