        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">Overtime History</h3>
		                ...
		                $.ajax({
		                    ...
		                    success:function(event, data)
		                    {
		                        if(event.Error==false)
		                        {
		                            ...
		                            //$('#btnGenerate').append('<a href="{{url("history/overtimePDF")}}" class="btn btn-primary" target="_blank"><em class="icon ni ni-download"></em><span>Generate PDF</span></a>');
		                            //$('#start').val("");
		                            //$('#end').val("");
		                        }
		                        else {
