        ...
        <div class="nk-block nk-block-lg">
            <div class="nk-block-head">
                <div class="nk-block-head-content">
                    <h4 class="nk-block-title">System Specification</h4>
                </div>
            </div>
            <div class="card card-preview">
                <div class="card-inner">
                    <ul class="nav nav-tabs" id="myTab5" role="tablist">
                        <li class="nav-item">
                        <a class="nav-link active" id="base-tab1" data-toggle="tab" aria-controls="tab1" href="#adminimage" aria-expanded="true">
                            <em class="icon ni ni-brick"></em> &nbsp; Admin Login Image</a>
                        </li>
                        <li class="nav-item">
                        <a class="nav-link" id="base-tab2" data-toggle="tab" aria-controls="tab2" href="#tenantimage" aria-expanded="false">
                            <em class="icon ni ni-puzzle"></em> &nbsp; Tenant Login Image</a>
                        </li>
                            ...
                            <div class="container">
                                <div class="row g-4">
                                    <div class="col-6 col-sm-4">
                                        ...
                                        <input type="file" id="imglogin1" name="imglogin" accept="image/x-png,image/gif,image/jpeg" onChange="saveImage(1,this,'admin')"/>
                                    ...
                                    <div class="col-6 col-sm-4">
                                        ...
                                        <input type="file" id="imglogin2" name="imglogin" accept="image/x-png,image/gif,image/jpeg" onChange="saveImage(2,this,'admin')"/>
                                        <p>(* Only Jpg, Png allowed)</p>
                                    ...
                                    <div class="col-6 col-sm-4">
                                        ...
                                        <input type="file" id="imglogin3" name="imglogin" accept="image/x-png,image/gif,image/jpeg" onChange="saveImage(3,this,'admin')"/>
                                        <p>(* Only Jpg, Png allowed)</p>
                            ...
                            <div class="container">
                                <div class="row g-4">
                                    <div class="col-6 col-sm-4">
                                        ...
                                        <input type="file" id="imglogin4" name="imglogin" accept="image/x-png,image/gif,image/jpeg" onChange="saveImage(4,this,'tenant')"/>
                                        <p>(* Only Jpg, Png allowed)</p>
                                    ...
                                    <div class="col-6 col-sm-4">
                                        ...
                                        <input type="file" id="imglogin5" name="imglogin" accept="image/x-png,image/gif,image/jpeg" onChange="saveImage(5,this,'tenant')"/>
                                        <p>(* Only Jpg, Png allowed)</p>
