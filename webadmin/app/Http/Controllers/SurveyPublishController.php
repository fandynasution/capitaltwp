...
class SurveyPublishController extends Controller
{
    ...
    public function form(){
        ...
        return view('survey.publish.form',$content);
    }
            ...
            // var_dump($form);exit();
                ...
                DB::connection('ifcaadm')->table('pm_survey_dt')->where($wheredlt)->delete();
                    ...
                    foreach ($subject as $surveyid) {
                        ...
                        ->where($wheretmp)
                        ->get(); 
                        // $datatmp = $this->m_wsbangun->getData_by_criteria_cons('ifca3','pm_tmpsurvey',$wheretmp);
                        $dataHD = array(
                            'publish_id' => $publish_id,
                            'quest_no'=>$i,
                            'subject'=>$datatmp[0]->subject,
    ...
    public function savepublish(Request $request)
    {
        ...
        // var_dump('publish:',$publish);
        // var_dump('expired:',$expired);
    ...
    {
        // var_dump($request->publish_id);exit();
