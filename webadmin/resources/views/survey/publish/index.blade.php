...
<script type="text/javascript">
    ...
    $(function(){
         tblpublishedd = $('#tblpublished').DataTable( 
        {
            ...
            "serverSide": true,
            "ajax":{
                "url":"{{ url('survey/publish/allpublished');}}",
        ...
        tblsurvey.on('click', 'tr', function() {
         ...
         $('#addparam').click(function(){
                ...
                $('#modalbodyxl').html("");
                $('#modalbodyxl').load("{{ url('/survey/publish/form') }}");
            ...
            Swal.fire({
                ...
                .then(function(a){
                    if (a.value==true) {
                        ...
                        $('#modalbodyxl').load("{{ url('/survey/publish/add') }}");
