...
<head>
    ...
    <script src="{{ url('assets/js/libs/jqvmap.js') }}"></script>
    ...
    <script src="{{ url('assets/js/blockui/jquery.block-ui.js') }}" type="text/javascript"></script>
    <script src="{{ url('assets/js/blockui/block-ui.min.js') }}" type="text/javascript"></script>
    <style type="text/css">
...
<body class="nk-body npc-default has-apps-sidebar has-sidebar ">
    <div class="nk-app-root">
        ...
        <div class="nk-main ">
            <!-- wrap @s -->
            <div class="nk-wrap ">
                @include('template.layout2.header')
                @include('template.layout2.sidebar')
                <!-- content @s -->
